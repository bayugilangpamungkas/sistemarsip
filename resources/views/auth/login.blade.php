...
<div class="row h-100">
			...
			<form action="{{ route('login') }}" method="POST">
				...
				<div class="form-group position-relative has-icon-left mb-4">
					<input type="email" class="form-control form-control-xl @error('email') is-invalid @enderror" name="email"
						id="email" placeholder="Email" value="" required>
				...
				<div class="form-group position-relative has-icon-left mb-4">
					<input type="password" class="form-control form-control-xl @error('password') is-invalid @enderror"
						name="password" id="password" placeholder="Password" value="" required>
					<div class="form-control-icon">
	...
	<div class="col-lg-7 d-none d-lg-block">
		<div id="auth-right">
            <img src="{{ asset('img/login_gambar.png') }}" style="width: 900px; position: fixed; margin-top: 50px; margin-left: 20px" alt="">
		</div>
	</div>
</div>
@endsection
